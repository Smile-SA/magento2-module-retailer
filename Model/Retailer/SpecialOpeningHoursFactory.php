...
/**
 * Factory class for @see \Smile\Retailer\Model\Retailer\SpecialOpeningHours
 *
 * @category Smile
 * @package  Smile\Retailer
 * @author   Romain Ruaud <romain.ruaud@smile.fr>
 */
class SpecialOpeningHoursFactory implements SpecialOpeningHoursFactoryInterface
{
    /**
     ...
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Smile\\Retailer\\Api\\Data\\SpecialOpeningHoursInterface')
    {
